...
export class ServiceBusClientLifecycle implements OnModuleDestroy {
    ...
    constructor(@Inject('SERVICEBUS_CLIENT') private readonly client: ServiceBusClient) { }
    ...
    async onModuleDestroy(): Promise<void> {
        try {
            ...
            this.logger.warn('Error closing ServiceBusClient in lifecycle provider', err as Error);
        }
    }
}
